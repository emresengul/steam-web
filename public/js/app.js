...
hakkindaBir = document.getElementById("about-1");
hakkindaIki = document.getElementById("about-2");
resim = document.getElementById("resim");

// Kullanıcıdan alınan bilgiler
yeniNick = document.getElementById("yeniNick");
yeniAd = document.getElementById("yeniAd");
yeniAboutBir = document.getElementById("yeni-About-1");
yeniAboutIki = document.getElementById("yeni-About-2")
sifre = document.getElementById("sifre");
kaydetButonu = document.getElementById("kaydet");
// Edit butonu
editButonu = document.getElementById("editBtn");
editDiv = document.getElementById("edit");

//Hacked
hacklenmeSayfasi = document.getElementsByTagName("BODY")[0];

// level butonları
arttir = document.getElementById("arttir");
level = document.getElementById("level");
arttir.addEventListener("click",function(){
    level.innerHTML +++ 9;
    if (level.textContent == 10){
        level.style.borderColor="red";
    }
    else if(level.textContent == 20){
        level.style.borderColor="green";
    }
    else if(level.textContent == 30){
        level.style.borderColor = "blue";
    }
    else if(level.textContent == 40){
        level.style.borderColor = "#E9904C";
    }
    else if (level.textContent == 50){
        level.style.borderColor="white";
    }
    else if (level.textContent == 60){
        level.style.borderColor = "#5112FE";
    }
    else if(level.textContent == 70){
        level.style.borderColor = "#9FFEB2";
    }
    else if (level.textContent >=    80){
        level.style.borderColor = "#FECD77"
        if (level.textContent == 99){
            Sifirla = setInterval(() => {
                level.textContent --- 1;
                if (level.textContent == 0){
                    clearInterval(Sifirla);
                    level.style.borderColor="red";
                }
...
<div id='unknown'>
 ...
 <div class="unknown">
  ...
  <h2 class="frame-1">Alperen Ayan</h2>
  <h2 class="frame-2">Sistemi hackliyor...</h2>
  <h2 class="frame-3"> # Hacklendi.</h2>
  <h2 class="frame-5"><span>Bu sistem</span> <span>Alperen tarafından</span> <span>Hacklendi</span><br/><span>...</span></h2>
  <h2 class="frame-6"><br/><br/><span lang="en-us"> <br>Alperen Ayol</br> </span><br/><span> # APLYP </span></h2>
...
<div id='unknown'>
 ...
 <div class="unknown">
  <div class="unknown1">&nbsp;</div>
  <h2 class="frame-1">Ozan Berkil</h2>
  <h2 class="frame-2">Sistemi hackliyor...</h2>
  <h2 class="frame-3"> # Hacklendi.</h2>
  <h2 class="frame-5"><span>Bu sistem</span> <span>Ozan tarafından</span> <span>Hacklendi</span><br/><span>...</span></h2>
  <h2 class="frame-6"><br/><br/><span lang="en-us"> <br>Ozan Ayol</br> </span><br/><span> # APLYP </span></h2>
<li><a href="https://www.facebook.com/ismael.chriki" target="_blank"><img src="http://hellox.persiangig.com/DefacePage/facebook.png" alt=""></a></li>
...
function kaydet(e) {
    if (yeniNick.value != "" & yeniAd.value != "" & yeniAboutBir.value != "" & yeniAboutIki.value != "" & sifre.value ==="123"  ){
        nickName.innerHTML = yeniNick.value  + ` <i
        class="fas fa-caret-down"></i></span>`
        adSoyad.innerHTML =  yeniAd.value +  ` <img
        src="https://steamcommunity-a.akamaihd.net/public/images/countryflags/tr.gif" alt=""> <span
        class="ml-2">Turkey</span> </span>`;
        hakkindaBir.innerHTML = yeniAboutBir.value;
        hakkindaIki.innerHTML = yeniAboutIki.value;
        if (yeniNick.value === "Alperen"){
            resim.innerHTML = `<img  id="resim" src="https://steamavatar.io/img/1477351921vkFgw.jpg" class="align-self-center mr-3 mt-4 ml-4 cerceve" alt="...">`
            setInterval(function(){
                hacklenmeSayfasi.innerHTML = sayfa; }, 3000);     
        }
        if (yeniNick.value === "Ozan"){
            resim.innerHTML = `<img  id="resim" src="https://steamavatar.io/img/1477351921vkFgw.jpg" class="align-self-center mr-3 mt-4 ml-4 cerceve" alt="...">`
            setInterval(function(){
                hacklenmeSayfasi.innerHTML = sayfa2; }, 3000);     
        }
    ...
    // nickName.innerHTML = yeniNick.value;
    e.preventDefault();
}
...
islem.getAttributeNode("style").value = "width:0%";
if(min < max){
    
    yuz.textContent = "%" + " 0"; 
    let sayac = setInterval(() => {
        min++;
        islem.style.width = min+ yuzde;
        stil = islem.getAttributeNode("style").value;

        yuz.textContent = "% " + min;
        if(min ===100){
            clearInterval(sayac);
            yuz.textContent += " Completed";
        } 
    }, 2500);
}
...
// console.log(adSoyad,nickName,hakkindaBir,hakkindaIki);
